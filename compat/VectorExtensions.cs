...
public static class VectorExtensions
{
    ...
    public static Point ToPoint(this Vector2 vector) => new(vector.X, vector.Y);
    ...
    public static Size ToSize(this Vector2 vector) => new(vector.X, vector.Y);
    ...
    /// <returns>A <see cref="Vector2"/></returns>
    public static Vector2 ToVector2(this Size size) => new((float)size.Width, (float)size.Height);
}
